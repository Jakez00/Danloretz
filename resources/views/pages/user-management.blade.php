                ...
                <div class="modal fade" id="edituser" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control" id="efirstname" name="efirstname" placeholder="firstname">
                            </div>
                            <div class="mb-3">
                                <input type="text" class="form-control" id="elastname" name="elastname" placeholder="firstname">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <select class="form-control" name="estore" id="estore">
                                    <option value="">--Choose Branch--</option>
                                    @foreach ($stores as $store)
                                    <option value="{{ $store->id }}">{{ $store->storename }}</option>
                                    @endforeach
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0 table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <input type="hidden" id="id" value="{{ $aes->encrypt($user->id) }}">
                                   ...
                                   <td><p class="text-sm font-weight-bold mb-0">{{ $user->storename}}</p></td>
